...
; 0000 00CC     {
_read_key:
; 0000 00CD         while (up1==0)
_0x4C:
	SBIC 0x16,0
	RJMP _0x4E
; 0000 00CE         {
; 0000 00CF         while (down2==0)
_0x4F:
	SBIC 0x13,1
	RJMP _0x51
; 0000 00D0             {
; 0000 00D1             nhietdodat=370;
	RCALL SUBOPT_0x16
	LDI  R30,LOW(370)
	LDI  R31,HIGH(370)
	RCALL __EEPROMWRW
; 0000 00D2             doamdat=600;
	RCALL SUBOPT_0x17
	LDI  R30,LOW(600)
	LDI  R31,HIGH(600)
	RCALL __EEPROMWRW
; 0000 00D3             }
	RJMP _0x4F
_0x51:
; 0000 00D4         nhietdodat++;
	RCALL SUBOPT_0x16
	RCALL SUBOPT_0x15
; 0000 00D5         lcd_putnum(nhietdodat,7,0);
	RCALL SUBOPT_0x18
	RCALL SUBOPT_0x19
...
; 0000 00D7         }
	RJMP _0x4C
_0x4E:
; 0000 00D8     while (down1==0)
_0x52:
	SBIC 0x13,0
	RJMP _0x54
; 0000 00D9         {
; 0000 00DA         nhietdodat--;
	RCALL SUBOPT_0x18
	SBIW R30,1
	RCALL __EEPROMWRW
	ADIW R30,1
; 0000 00DB         lcd_putnum(nhietdodat,7,0);
	RCALL SUBOPT_0x18
	RCALL SUBOPT_0x19
...
_0x54:
; 0000 00DE 
; 0000 00DF     while (up2==0)
_0x55:
	SBIC 0x16,1
	RJMP _0x57
; 0000 00E0         {
; 0000 00E1         while (down1==0)
_0x58:
	SBIC 0x13,0
	RJMP _0x5A
; 0000 00E2             {
...
; 0000 00E5         doamdat++;
	RCALL SUBOPT_0x17
	RCALL SUBOPT_0x15
; 0000 00E6         lcd_putnum(doamdat,7,1);
	RCALL SUBOPT_0x1A
	RCALL SUBOPT_0x1B
...
; 0000 00EB         doamdat--;
	...
	RCALL __EEPROMWRW
	ADIW R30,1
; 0000 00EC         lcd_putnum(doamdat,7,1);
	RCALL SUBOPT_0x1A
	RCALL SUBOPT_0x1B
; 0000 00ED         delay_ms(300);
; 0000 00EE         }
	RJMP _0x5B
_0x5D:
; 0000 00EF     }
...
; 0000 00FE // Func6=In Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 00FF // State6=T State5=T State4=T State3=T State2=T State1=T State0=T
; 0000 0100 PORTC=0xff;
	LDI  R30,LOW(255)
	OUT  0x15,R30
; 0000 0101 DDRC=0b11111100;
	LDI  R30,LOW(252)
	OUT  0x14,R30
; 0000 0102 
; 0000 0103 // Port D initialization
; 0000 0104 // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0105 // State7=T State6=T State5=T State4=T State3=T State2=T State1=T State0=T
...
; 0000 010B // Clock value: Timer 0 Stopped
; 0000 010C TCCR0=0x00;
	RCALL SUBOPT_0x10
...
; 0000 0111 // Clock value: 15.625 kHz
; 0000 0112 // Mode: CTC top=OCR1A
; 0000 0113 // OC1A output: Discon.
; 0000 0114 // OC1B output: Discon.
...
; 0000 0119 // Compare A Match Interrupt: On
; 0000 011A // Compare B Match Interrupt: Off
; 0000 011B TCCR1A=0x00;
	RCALL SUBOPT_0x1C
; 0000 011C TCCR1B=0x0D;
; 0000 011D TCNT1H=0x00;
; 0000 011E TCNT1L=0x00;
; 0000 011F ICR1H=0x00;
; 0000 0120 ICR1L=0x00;
; 0000 0121 OCR1AH=0x3D;
; 0000 0122 OCR1AL=0x09;
; 0000 0123 OCR1BH=0x00;
; 0000 0124 OCR1BL=0x00;
; 0000 0125 
; 0000 0126 // Timer/Counter 2 initialization
; 0000 0127 // Clock source: System Clock
; 0000 0128 // Clock value: Timer2 Stopped
; 0000 0129 // Mode: Normal top=0xFF
; 0000 012A // OC2 output: Disconnected
; 0000 012B ASSR=0x00;
	LDI  R30,LOW(0)
	OUT  0x22,R30
; 0000 012C TCCR2=0x00;
	OUT  0x25,R30
...
; 0000 0151 // RS - PORTD Bit 7
; 0000 0152 // RD - PORTD Bit 6
; 0000 0153 // EN - PORTD Bit 5
; 0000 0154 // D4 - PORTD Bit 4
; 0000 0155 // D5 - PORTD Bit 3
; 0000 0156 // D6 - PORTD Bit 2
; 0000 0157 // D7 - PORTD Bit 1
; 0000 0158 // Characters/line: 16
; 0000 0159 lcd_init(16);
	LDI  R30,LOW(16)
	ST   -Y,R30
	RCALL _lcd_init
; 0000 015A lcd_putsf("Start System.....");
	__POINTW1FN _0x0,2
	RCALL SUBOPT_0x1D
...
; 0000 015F delay_ms(200);
	RCALL SUBOPT_0x21
; 0000 0160 lcd_putsf("F");
	__POINTW1FN _0x0,25
	RCALL SUBOPT_0x1D
; 0000 0161 delay_ms(200);
	RCALL SUBOPT_0x21
; 0000 0162 lcd_putsf("a");
	__POINTW1FN _0x0,27
	RCALL SUBOPT_0x1D
; 0000 0163 delay_ms(200);
	RCALL SUBOPT_0x21
; 0000 0164 lcd_putsf("i");
	__POINTW1FN _0x0,29
	RCALL SUBOPT_0x1D
; 0000 0165 delay_ms(200);
	RCALL SUBOPT_0x21
; 0000 0166 lcd_putsf("r");
	__POINTW1FN _0x0,31
	RCALL SUBOPT_0x1D
; 0000 0167 delay_ms(200);
	RCALL SUBOPT_0x21
; 0000 0168 lcd_putsf("y");
	__POINTW1FN _0x0,33
	RCALL SUBOPT_0x1D
...
; 0000 016B delay_ms(200);
	RCALL SUBOPT_0x21
; 0000 016C lcd_putsf("E");
	__POINTW1FN _0x0,37
	RCALL SUBOPT_0x1D
; 0000 016D delay_ms(200);
	RCALL SUBOPT_0x21
; 0000 016E lcd_putsf("l");
	__POINTW1FN _0x0,39
	RCALL SUBOPT_0x1D
; 0000 016F delay_ms(200);
	RCALL SUBOPT_0x21
; 0000 0170 lcd_putsf("a");
	__POINTW1FN _0x0,27
	RCALL SUBOPT_0x1D
; 0000 0171 delay_ms(200);
	RCALL SUBOPT_0x21
; 0000 0172 lcd_putsf("b");
	__POINTW1FN _0x0,41
	RCALL SUBOPT_0x1D
...
; 0000 017D TCCR1A=0x00;
	RCALL SUBOPT_0x1C
; 0000 017E TCCR1B=0x0D;
; 0000 017F TCNT1H=0x00;
; 0000 0180 TCNT1L=0x00;
; 0000 0181 ICR1H=0x00;
; 0000 0182 ICR1L=0x00;
; 0000 0183 OCR1AH=0x3D;
; 0000 0184 OCR1AL=0x09;
...
; 0000 018D         lcd_gotoxy(0,0);
	...
	RCALL _lcd_gotoxy
; 0000 018E 
; 0000 018F         lcd_putnum(nhietdo,1,0);
	LDS  R30,_nhietdo
	LDS  R31,_nhietdo+1
	LDS  R22,_nhietdo+2
	LDS  R23,_nhietdo+3
	...
	RCALL SUBOPT_0x1E
	RCALL _lcd_putnum
; 0000 0190         lcd_putnum(nhietdodat,7,0);
	RCALL SUBOPT_0x18
	RCALL SUBOPT_0x22
	RCALL SUBOPT_0x1E
	RCALL _lcd_putnum
; 0000 0191         lcd_gotoxy(0,1);
	RCALL SUBOPT_0x1E
	RCALL SUBOPT_0x1F
	RCALL _lcd_gotoxy
; 0000 0192 
; 0000 0193         lcd_putnum(doam,1,1);
	LDS  R30,_doam
	LDS  R31,_doam+1
	LDS  R22,_doam+2
	LDS  R23,_doam+3
	...
	RCALL SUBOPT_0x1F
	RCALL _lcd_putnum
; 0000 0194         lcd_putnum(doamdat,7,1);
	RCALL SUBOPT_0x1A
	RCALL SUBOPT_0x22
	RCALL SUBOPT_0x1F
	RCALL _lcd_putnum
; 0000 0195         lcd_putnum1(sldao,13,0);
	MOVW R30,R6
	RCALL SUBOPT_0x23
	RCALL __PUTPARD1
	LDI  R30,LOW(13)
	...
	RCALL _lcd_putnum1
; 0000 0196 
; 0000 0197       if ( nhietdo < nhietdodat-3 ) role1=0;
	RCALL SUBOPT_0x18
	SBIW R30,3
	RCALL SUBOPT_0x24
	RCALL __CPD21
	BRGE _0x65
	CBI  0x15,2
; 0000 0198       if ( nhietdo > nhietdodat+2 ) role1=1;
_0x65:
	RCALL SUBOPT_0x18
	ADIW R30,2
	RCALL SUBOPT_0x24
	...
	BRGE _0x68
	SBI  0x15,2
; 0000 0199       if ( doam < doamdat-20 ) role2=0;
_0x68:
	RCALL SUBOPT_0x1A
	SBIW R30,20
	RCALL SUBOPT_0x25
	...
	BRGE _0x6B
	CBI  0x15,3
; 0000 019A       if ( doam > doamdat+20 ) role2=1;
_0x6B:
	RCALL SUBOPT_0x1A
	ADIW R30,20
	RCALL SUBOPT_0x25
	...
	BRGE _0x6E
	SBI  0x15,3
; 0000 019B       if ((nhietdo < 350)|(doam < 500)|(nhietdo > 385)|(doam > 800)) error=0;
_0x6E:
	RCALL SUBOPT_0x26
	__GETD1N 0x15E
	RCALL __LTD12
	...
	CLT
	BLD  R2,0
; 0000 019C       else { error=1; role4=1;}
	RJMP _0x72
_0x71:
	SET
	BLD  R2,0
