...
; 0000 0027     ht_count_egg=count_egg;
	RCALL SUBOPT_0x1
	MOVW R12,R30
; 0000 0028     if (count_egg >= 240) {set_egg=1; count_egg=0;}
	RCALL SUBOPT_0x1
	CPI  R30,LOW(0xF0)
	LDI  R26,HIGH(0xF0)
	CPC  R31,R26
...
_0x9D:
	...
	RJMP _0x9F
; 0000 01F1             {
; 0000 01F2             delay_mms(70);
	LDI  R30,LOW(70)
	LDI  R31,HIGH(70)
	RCALL SUBOPT_0x4
; 0000 01F3             if(button_m==0) button_motor=0; else button_motor=1;
	SBIC 0x16,4
	RJMP _0xA0
	CLT
	RJMP _0xCC
...
; 0000 01FC             }
; 0000 01FD 
; 0000 01FE         hienthi_lcd();
_0x9A:
	RCALL _hienthi_lcd
; 0000 01FF         set_key=0;
	CLT
	BLD  R2,1
; 0000 0200         if (dttudong==on) led=1;
	RCALL SUBOPT_0x27
	RCALL __EEPROMRDW
	SBIW R30,0
	BRNE _0xA4
	SBI  0x18,1
; 0000 0201             else {led=0; count_eep=0; set_egg=0; ht_count_egg=0; }
	RJMP _0xA7
_0xA4:
	CBI  0x18,1
	CLR  R10
